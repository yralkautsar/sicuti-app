    ...
    <div className="flex h-screen overflow-hidden" style={{ background: '#FAFAFA' }}>
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <header className="px-8 py-4 flex items-center justify-between flex-shrink-0"
          ...
          <div>
            <h1 className="font-bold text-lg" style={{ color: '#442F78' }}>Manajemen Kelas</h1>
            <p className="text-xs" style={{ color: '#A78BFA' }}>{Object.keys(grouped).length} kelas · {classes.length} angkatan terdaftar</p>
          </div>
